...
function getImageUrl(image) {
    if (!image) return '/static/images/20260128190942_s25_ultra.jpg';
...
function displayCategoryList(categoriesList) {
    ...
    categoriesList.forEach(cat => {
        ...
        const categoryImageUrl = getImageUrl(cat.category_image);

        categoryCard.innerHTML = `
            <div class="category-image">
                <img src="${categoryImageUrl}" alt="${cat.category}" onerror="this.src='/static/images/20260128190942_s25_ultra.jpg'">
            </div>
...
function displayProducts(productsList, containerId = 'productsGrid') {
    ...
    productsList.forEach(product => {
        ...
        let rowImageUrl = product.image ? product.image : '20260128190942_s25_ultra.jpg';
        if (product.image && !product.image.startsWith('http') && !product.image.startsWith('/')) {
            rowImageUrl = `/static/images/${product.image}`;
        }

        productCard.innerHTML = `
            <img src="${rowImageUrl}" alt="${product.p_name}" class="product-image" onerror="this.onerror=null;this.src='/static/images/20260128190942_s25_ultra.jpg';">
